      ...
      <div className="flex-grow flex flex-row">
        ...
        <div className="flex-grow flex flex-col items-center justify-center py-8">
          <div className="bg-white/90 rounded-2xl shadow-xl p-8 w-full max-w-xl">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-6 drop-shadow-lg text-center">Update Marks</h2>
            <form className="flex flex-col gap-6" onSubmit={e => { e.preventDefault(); navigate('/admin-marks'); }}>
              ...
              <button type="submit" className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-extrabold rounded-xl shadow-lg hover:scale-105 transition-all text-lg tracking-wide">Update Marks</button>
            </form>
          </div>
        </div>
      </div>
